...
function ArtigosPage() {
  ...
  if (loading) {
    return (
      <div className="bg-slate-800 py-20 min-h-screen flex items-center justify-center">
        <LoadingSpin />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="bg-slate-800 py-20 min-h-screen flex flex-col items-center justify-center text-red-600">
        ...
        <p className="mt-4 text-center text-slate-400">Não foi possível carregar os artigos.</p>
      </div>
    );
  }
