  ...
  return (
    <>
      ...
      <div className='flex flex-col w-full items-center'>
        ...
        <div className='grid grid-cols-3 grid-row-2 w-[90%] xl:w-[75%] mt-10 space-y-10 max-lg:flex max-lg:flex-col'>
      ...
      <span className='w-full h-full bg-slate-900/40 flex flex-col items-center max-lg:justify-center'>
        ...
        <div className='w-[85%] xl:w-[75%] grid grid-cols-2 max-lg:flex max-lg:flex-col max-lg:items-center'>
          <div className='xl:h-200 xl:col-span-1'>
            <CardHome
              name='Ultima noticia' image='../../../public/imagens/imageEnsino.jpeg' conteudo='aqui e um conteudo muito importante para ler' size='large'
            ></CardHome>
          </div>
        ...
        <div className='w-full h-[200px] md:h-[300px] xl:h-[500px] bg-slate-600/70 shadow-2xl shadow-slate-900/25 mt-10 flex flex-col items-center justify-center
               space-y-5 xl:space-y-10'>
