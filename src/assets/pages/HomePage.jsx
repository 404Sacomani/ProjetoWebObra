...
function HomePage() {
  ...
  const cardArtigos = [
    {
      type: 'Artigo',
      name: 'Inovação em Construção',
      conteudo: 'Explore nossos projetos inovadores que aplicam os fundamentos da engenharia civil, abrangendo áreas como estruturas, hidráulica e geotecnia, com foco em soluções práticas e eficientes para desafios contemporâneos.',
      image: '../../../public/imagens/img_cr_07.jpeg'
    },
    {
      type: 'Artigo',
      name: 'Soluções Sustentáveis',
      conteudo: 'Descubra como implementamos práticas sustentáveis em nossos projetos, promovendo a eficiência energética e o uso responsável de materiais, garantindo um impacto positivo no meio ambiente e na sociedade.',
      image: '../../../public/imagens/img_cr_11.png'
    },
    {
      type: 'Artigo',
      name: 'Obra Ativa',
      conteudo: 'Nossos projetos utilizam tecnologia de ponta, como simuladores e ferramentas interativas, para otimizar cálculos e resolver problemas complexos, capacitando estudantes e profissionais a alcançarem resultados excepcionais.',
      image: '../../../public/imagens/img_cr_12.png'
    },
    {
      type: 'Artigo',
      name: 'Gestão de Obras',
      conteudo: 'Plataforma dedicada ao ensino e prática dos fundamentos da engenharia civil e suas aplicações.',
      image: '../../../public/imagens/img_cr_18.jpeg'
      ...
      <span className='w-full h-full bg-slate-900/40 flex flex-col items-center max-lg:justify-center'>
        ...
        <div className='w-[85%] xl:w-[75%] grid grid-cols-2 max-lg:flex max-lg:flex-col max-lg:items-center'>
          <div className='xl:h-200 xl:col-span-1'>
            <CardHome
              name='Tecnologia Avançada' image='../../../public/imagens/img_cr_13.jpeg' conteudo='A gestão eficiente de obras é essencial para o sucesso de qualquer projeto. Conheça nossas abordagens e metodologias que garantem a entrega pontual e dentro do orçamento, assegurando qualidade e segurança.' size='large'
            ></CardHome>
          </div>
